package cz.cvut.fel.ear.lingo.flashcard_service.rest;

import cz.cvut.fel.ear.lingo.flashcard_service.adapter.FlashcardAdapter;
...
public class FlashcardController {
    ...
    public ResponseEntity<Void> crateFlashcard(@Valid @RequestBody FlashcardModel flashcardModel, @CurrentUser UserDetailsImpl userDetails) {
        flashcardAdapter.createFlashcard(flashcardModel, userDetails.getUser().getId());
