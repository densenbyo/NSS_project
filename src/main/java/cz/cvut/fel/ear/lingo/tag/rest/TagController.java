...
public class TagController {
    ...
    @PutMapping(value = "/{id}")
    public ResponseEntity<Void> updateTag(@Valid @PathVariable Long id,
                                          @Valid @RequestBody TagModel tagModel) {
    ...
    public ResponseEntity<Void> removeFlashcardFromTag(@Valid @PathVariable Long id,
                                                     @Valid @PathVariable Long idCard) {
